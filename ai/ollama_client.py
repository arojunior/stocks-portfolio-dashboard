"""
Ollama AI Client Module
Handles local AI analysis using Ollama
"""
...
class OllamaClient:
    ...
    def analyze_portfolio(self, portfolio_data: List[Dict], metrics: Dict) -> Optional[str]:
        ...
        try:
            ...
            print(f"Error generating Ollama analysis: {e}")
            return None

    def analyze_stock(self, ticker: str, stock_data: Dict) -> Optional[str]:
        """Generate individual stock analysis using Ollama"""
        if not self.available:
            return None
        ...
        try:
            ...
            print(f"Error generating Ollama stock analysis: {e}")
            return None
    ...
    def generate_trading_signals(self, portfolio_data: List[Dict]) -> List[Dict]:
        ...
        for stock in portfolio_data:
            try:
                ...
                signal_text = response['response'].strip()
